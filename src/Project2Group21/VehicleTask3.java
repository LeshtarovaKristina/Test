...
public class VehicleTask3 {
    /*
    Create a Class Car that would have the following fields: carPrice and method calculateSalePrice() which
...
returned car price should include 5% discount, otherwise 10% discount
    ...
    public VehicleTask3(double vehiclePrice) {
...
class  Sedan extends VehicleTask3 {
...
class Truck extends VehicleTask3 {
